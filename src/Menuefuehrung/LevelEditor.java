...
public class LevelEditor extends /*JPanel*/ Render implements MouseListener, Filesystem {
    ...
    protected void paintComponent(Graphics g) {
        ...
        pic =current_skin.getImage("diamond", field_size);
        ...
        g.drawString( text, margin_x, margin_y+fontSize);
        margin_x +=g.getFontMetrics().stringWidth(text)+off_right;
        pic = current_skin.getImage("tunnel_hori", field_size);
        current_skin.invertImage(pic);
        g.drawImage(pic, margin_x, margin_y, null);
        margin_x += pic.getWidth()+off_left;
        ...
        g.drawString( text, margin_x, margin_y+fontSize);
        margin_x +=g.getFontMetrics().stringWidth(text)+off_right;
        pic =current_skin.getImage("tunnel_vert", field_size);
        current_skin.invertImage(pic);
        g.drawImage(pic, margin_x, margin_y, null);
        margin_x += pic.getWidth()+off_left;
        ...
        g.drawString( text, margin_x, margin_y+fontSize);
        margin_x +=g.getFontMetrics().stringWidth(text)+off_right;
        pic =current_skin.getImage("tunnel_space", field_size);
        current_skin.invertImage(pic);
        g.drawImage(pic, margin_x, margin_y, null);
        margin_x += pic.getWidth()+off_left;
        ...
        g.drawString( text, margin_x, margin_y+fontSize);
        margin_x +=g.getFontMetrics().stringWidth(text)+off_right;
        pic =current_skin.getImage("statusbar_digger_MP_red", field_size);
        g.drawImage(pic, margin_x, margin_y, null);
        margin_x += pic.getWidth()+off_left;
        ...
        g.drawString( text, margin_x, margin_y+fontSize);
        margin_x +=g.getFontMetrics().stringWidth(text)+off_right;
        pic =current_skin.getImage("statusbar_digger_MP_gre", field_size);
        g.drawImage(pic, margin_x, margin_y, null);
        margin_x += pic.getWidth()+off_left;
        ...
        g.drawString( text, margin_x, margin_y+fontSize);
        margin_x +=g.getFontMetrics().stringWidth(text)+off_right;
        pic =current_skin.getImage("money_static", field_size);
        g.drawImage(pic, margin_x, margin_y, null);
        margin_x += pic.getWidth()+off_left;
        ...
        g.drawString( text, margin_x, margin_y+fontSize);
        margin_x +=g.getFontMetrics().stringWidth(text)+off_right;
        pic = current_skin.getImage("cherry", field_size);
        g.drawImage(pic, margin_x, margin_y, null);
        margin_x += pic.getWidth()+off_left;

        g.drawString( "Str+S: Save", margin_x, margin_y+fontSize);
